package com.medusa.gruul.common.netty.standard;

import com.medusa.gruul.common.netty.annotation.WebSocketEndpoint;
import com.medusa.gruul.common.netty.autoconfigure.annotation.EnableWebSocket;
import com.medusa.gruul.common.netty.domain.WebSocketEndpointServer;
import com.medusa.gruul.common.netty.domain.WebSocketMethodMapping;
import com.medusa.gruul.common.netty.exception.WebSocketException;
    ...
    private void init() {
        for (Map.Entry<InetSocketAddress, WebsocketServer> entry : addressWebsocketServerMap.entrySet()) {
            ...
            try {
                ...
                logger.info(String.format("\033[34mNetty WebSocket started on port: %s with context path(s): %s .\033[0m", Arrays.toString(webSocketEndpointServer.getPorts()), stringJoiner));
...
//        for(int port : webSocketEndpointConfig.getPorts()){
        InetSocketAddress inetSocketAddress = new InetSocketAddress(
                webSocketEndpointConfig.getHost(),
                webSocketEndpointConfig.getPorts()[0]
        );
...
//        }
    ...
    private WebSocketEndpointConfig buildWebSocketConfig(WebSocketEndpoint annotation) {
        ...
        int[] port = resolveAnnotationValue(annotation.port(), int[].class, "ports");
