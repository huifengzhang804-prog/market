...
public class SuperAdminMenuStrategy implements IStrategy<Roles, Void, List<MenuVO>> {

    private final IMenuService menuService;

    @Override
    public List<MenuVO> execute(Roles type, Void param) {
        return menuService.menuTree(ClientType.PLATFORM_CONSOLE, 0L, (Boolean) null);
    }
}
