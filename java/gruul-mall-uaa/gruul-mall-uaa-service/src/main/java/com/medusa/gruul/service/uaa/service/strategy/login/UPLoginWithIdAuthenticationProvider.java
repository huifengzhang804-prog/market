 ...
 */
@Component
@GrantType("upLoginWithId")
@RequiredArgsConstructor
public class UPLoginWithIdAuthenticationProvider implements IAuthenticationProvider<UPLoginWithIdAuthenticationProvider.UsernamePassword> {
...
//        String decryptPassword = authentication.getPassword();
     ...
     /*   SecureUser secureUser = new SecureUser();
        secureUser.setMobile(user.getMobile());
        secureUser.setUsername(user.getUsername());
        return secureUser;*/

        return reloadUserProvider.loadUser(ISystem.clientTypeMust(), SecurityConst.NO_SHOP_ID_CLIENT_DEFAULT_SHOP_ID, user);
    }
