...
api[0].list[0].list.push({
    order: '5',
    deprecated: 'false',
    url: '/addon-member/paid/member/info',
    desc: '付费会员配置详情',
});
api[0].list[0].list.push({
    order: '6',
    deprecated: 'false',
    url: '/addon-member/paid/member/saveLabel',
    desc: '付费会员标签设置',
});
api[0].list[0].list.push({
    order: '7',
    deprecated: 'false',
    url: '/addon-member/paid/member/rank',
    desc: '付费会员级别列表----移动端',
});
api[0].list[0].list.push({
    order: '8',
    deprecated: 'false',
    url: '/addon-member/paid/member/pay',
    desc: '付费会员购买',
});
