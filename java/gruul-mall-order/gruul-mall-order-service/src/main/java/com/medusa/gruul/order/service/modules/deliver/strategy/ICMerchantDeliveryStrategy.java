...
public class ICMerchantDeliveryStrategy implements IStrategy<DeliverType, DeliveryParam, ShopOrderPackage> {
    ...
    public ShopOrderPackage execute(DeliverType type, DeliveryParam param) {
        ...
        List<ShopOrderItem> shopOrderItem = TenantShop.disable(
                () -> shopOrderItemService.lambdaQuery()
                        .select(ShopOrderItem::getAfsNo, ShopOrderItem::getAfsStatus, ShopOrderItem::getProductName, ShopOrderItem::getSpecs, ShopOrderItem::getNum)
        ...
        ShopOrderPackage shopOrderPackage = new ShopOrderPackage()
                ...
                .setType(DeliverType.IC_MERCHANT)
        ...
        orderAddonDistributionSupporter.icOrderReport(
                ...
                new ICOrder()
                        ...
                        .setSkus(
                                shopOrderItem.stream()
                                        .map(
                                                item -> new ICProductSku()
