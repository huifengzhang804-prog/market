...
function loadRemoteComponent() {
    ...
    return renderScript(
        ...
        `${isDev ? import.meta.env.VITE_PLUGIN_URL : import.meta.env.VITE_BASE_URL}${props.service}/public/${props.name}/index.umd.js`,
        props.name,
...
<template>
    <el-skeleton v-show="loadStatus === LoadStatus.LOADING" :rows="6" style="padding: 16px" />
