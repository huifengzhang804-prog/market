import { RequestOptions, RequestOptionsWithIsSingleServer } from '#/types/axios'
 ...
 */
function exchangeServer(url: string, config: Partial<RequestOptionsWithIsSingleServer>) {
