        ...
        <div class="classificate__sort">
            <div
                ...
                :style="{
                    ...
                    // color: $props.currentChooseId === item.id ? $props.config.fontSelected : $props.config.fontNotSelected,
                    // background: $props.currentChooseId === item.id ? $props.config.bgSelected : $props.config.bgNotSelected,
                }"
