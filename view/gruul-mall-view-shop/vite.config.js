    ...
    return {
        ...
        server: {
            ...
            proxy: {
                '/cosimg': {
                    // 获取请求中带 /cosimg 的请求
                    target: 'https://medusa-small-file-1253272780.cos.ap-shanghai.myqcloud.com', // 后台服务器的源
                    changeOrigin: true, // 修改源
                    rewrite: (path) => path.replace(/^\/cosimg/, ''), //  /cosimg 替换为空字符串
                },
                '^/proxy': {
        ...
        plugins: [
            ...
            AutoImport({
                ...
                resolvers: [
                    ...
                    // dirResolver({
                    //     target: 'src/AutoImportCustomUse',
                    //     include: ['useConvert', 'usePriceRange'],
                    // }),
                ],
