...
import { ApiResponse, DefaultFormType } from './types'
 ...
 * 保存角色
 */
export const saveRole = (data: { roleId: string; roleName: string | null; menuIds: string[] }) => {
    return post({
        url: '/gruul-mall-uaa/uaa/role/menu',
        data,
    })
 ...
 * 编辑角色
 */
export const editRole = (roleId: string, { roleName, menuIds }: { roleName: string | null; menuIds: string[] }) => {
    return put({
        url: `/gruul-mall-uaa/uaa/role/menu/${roleId}`,
        data: {
            roleName,
 ...
 * @param data
 */
export const newShopCustomAdmin = (data: DefaultFormType) => {
    return post({
        showLoading: false,
        url: '/gruul-mall-uaa/uaa/shop/admin',
        data,
 ...
 * 编辑店铺自定义管理员
 */
export const updateShopCustomAdmin = (dataId: string, data: DefaultFormType) => {
    return put({
        showLoading: false,
 ...
 * 查询当前店铺可用作管理员的用户
 */
export const getAvailableUser = (keywords: string) => {
 ...
 * 根据用户id查询管理员注册资料
 */
export const getAdminRegisterDataById = (userId: string) => {
    return get({
        showLoading: false,
 ...
 * @param status
 */
export const enableDisableShopCustomAdmin = (dataId: string, status: string) => {
    return patch({
        showLoading: false,
 ...
 * 移除店铺管理员
 */
export const deleteShopAdmin = (dataId: string) => {
    return del({
        showLoading: false,
        url: `/gruul-mall-uaa/uaa/shop/admin/${dataId}`,
    })
