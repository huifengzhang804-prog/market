...
/**
 * 创建地图实例
 * AMap.Geolocation 获取当前位置定位 AMap.PlaceSearch 搜索周边  AMap.AutoComplete 搜索提示  AMap.Geocoder 逆地理编码
 */
function initMap() {
    AMapLoader.load({
        ...
        .then((AMap) => {
            ...
            //设置中心店
            console.log('设置中心店', $props.coordinates)
