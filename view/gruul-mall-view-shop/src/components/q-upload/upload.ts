 ...
 */
async function verifyFormat(rawFile: CusUploadRawFile, uploadConfig: Partial<UploadConfig>, cropper: boolean, uploadRef: any) {
    ...
    return { success, src: cropper ? imageObject.src : rawFile.raw, type: rawFile.raw!.type as keyof typeof IMAGETYPE }
}
/**
 * 异常抛错
