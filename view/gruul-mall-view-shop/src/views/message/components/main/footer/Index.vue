<template>
    <div class="footer-content">
        <el-header class="header">
            <ChatToolbar
                v-if="user?.chatWithShopInfo.shopId && +user.chatWithShopInfo.shopId > 0"
                :user="user"
...
import { MessageType, MessageUser, ToolbarMessage, ToolbarMessageType, ChatMessage } from '@/views/message/components/types'
