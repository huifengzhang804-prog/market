...
const basicOptions = [
    { label: '全部', value: '' },
    { label: '商品交易', value: 'ORDER_PAID', type: 'in' },
    ...
    { label: '运费', value: 'ORDER_FREIGHT', type: 'in' },
    { label: '返利抵扣', value: 'REBATE_DEDUCTION', type: 'in' },
    { label: '平台服务费', value: 'SYSTEM_SERVICE', type: 'out' },
...
<template>
    ...
    <div class="tab_container">
        <div class="fiance-tabs">
            ...
            <div class="fiance-tabs__export">
                <QIcon name="icon-wenhao" size="18px" color="#333" @click="showDescriptionDialog = true" />
            </div>
        </div>
    </div>
    <div class="handle_container" style="color: #333">
    ...
    />
    <el-dialog v-model="showDescriptionDialog" title="店铺对账说明" center :width="950">
