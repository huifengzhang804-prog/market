...
<template>
    <div class="videoCom" :style="{ padding: $props.formData.radioTC === 2 ? '10px' : '' }">
        <video v-if="formData.video" :src="formData.video" style="width: 100%; height: 200px" controls />
        <img v-else src="https://qiniu-app.qtshe.com/u391.png" style="width: 100%; height: 200px" />
        <i
