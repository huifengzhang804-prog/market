...
async function initTemplate() {
    ...
    if (data.records[0]) changeCurrentTemplate(data.records[0].id)
}
/**
 * 初始化页面列表
 */
        ...
        <div class="template--right">
            ...
            <el-table :data="templateList" border max-height="570" style="width: 100%">
                ...
                <el-table-column align="center" label="操作" prop="address" width="180">
                    <template #default="{ row }">
                        <span style="color: #0f40f5; cursor: pointerp; margin-right: 20px" @click="handleOpenDialog(row.id)">编辑</span>
