    ...
    <div class="item">
        ...
        <el-scrollbar height="400px">
            <el-row v-for="item in itemSku" :key="item.id" :gutter="20" justify="space-around" style="margin-left: 0px; margin-right: 0px">
                ...
                <el-col :span="5"><el-input-number v-model="item.price" type="text" :controls="false" /></el-col>
                <el-col :span="5"><el-input-number v-model="item.salePrice" type="text" :controls="false" /></el-col>
            </el-row>
        </el-scrollbar>
    </div>
</template>
