...
import type { ReceiverAreaDataParams, SkuInfos, Freights } from '@/pluginPackage/order/confirmOrder/types'
const { includeBenefit } = useMember()
/**
 * @description: 组装获取运费数据
 */
export function initCommodityLogisticsInfo(shopProducsList: StoragePackage[], area: string[], address: string) {
