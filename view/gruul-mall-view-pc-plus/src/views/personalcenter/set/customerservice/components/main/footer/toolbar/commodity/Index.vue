...
import { ApiGoodItemType, MessageType } from '@/views/personalcenter/set/customerservice/types'
...
const loadMoreItems = async () => {
  ...
  loading.value = true
  // const { code, data } = await doGetRetrieveCommodity({ ...searchType, searchTotalStockGtZero: true })
  // if (code === 200) {
