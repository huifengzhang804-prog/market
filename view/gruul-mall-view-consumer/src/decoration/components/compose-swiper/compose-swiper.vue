  ...
  <view>
    <view v-if="swiperList.length > 0" class="homeSwiper">
      <swiper
        ...
        :interval="2000"
        :duration="500"
        :previous-margin="padding + 'px'"
        :next-margin="padding + 'px'"
        :style="{ height }"
        @change="onChange"
      >
        <swiper-item
        ...
        >
          <view class="homeSwiper-swiper__image" :style="'padding: 0 ' + padding / 2 + 'px'" :class="{ swiperActive: index === curent }">
            <image
