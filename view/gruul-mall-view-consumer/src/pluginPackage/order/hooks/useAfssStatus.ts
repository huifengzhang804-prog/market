import type { A_REfUND_WHY, AFSSTATUS, ARefundType } from '@pluginPackage/order/applyAfterSales/types'

export { systemInfo, aRefundWhy, aRefundType, deliveryType, getARefundReasonCn, getAsfsStatusBtnCn, getAfsStatusCn }
 ...
 */
const systemInfo = {
  avatar: 'https://obs.xiaoqa.cn/gruul/20221210/4eb37859bb61495ab31df69a34fb6048.webp',
  name: '系统',
}
