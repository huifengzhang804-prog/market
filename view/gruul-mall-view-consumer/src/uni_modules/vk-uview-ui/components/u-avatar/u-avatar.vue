<template>
    <view class="u-avatar" :style="[wrapStyle]" @tap="click">
        <image v-if="!uText && avatar" :style="[imgStyle]" class="u-avatar__img" :src="avatar" :mode="imgMode" @error="loadError"></image>
        <text
            v-else-if="uText"
            class="u-line-1"
            :style="{
        ...
        <slot v-else></slot>
        <view v-if="showSex" class="u-avatar__sex" :class="['u-avatar__sex--' + sexIcon]" :style="[uSexStyle]">
