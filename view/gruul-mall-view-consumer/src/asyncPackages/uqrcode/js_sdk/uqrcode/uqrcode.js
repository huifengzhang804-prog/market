...
;(o.prototype = {
  ...
  (e.prototype = {
    ...
    make: function () {
      if (this.typeNumber < 1) {
        var o = 1
        for (o = 1; o < 40; o++) {
          for (var e = p.getRSBlocks(o, this.errorCorrectLevel), r = new C(), t = 0, i = 0; i < e.length; i++) t += e[i].dataCount
          for (i = 0; i < this.dataList.length; i++) {
            var n = this.dataList[i]
            r.put(n.mode, 4), r.put(n.getLength(), l.getLengthInBits(n.mode, o)), n.write(r)
          }
    ...
    createMovieClip: function (o, e, r) {
      ...
      for (var i = 0; i < this.modules.length; i++)
        for (var n = 1 * i, a = 0; a < this.modules[i].length; a++) {
          var s = 1 * a
          this.modules[i][a] && (t.beginFill(0, 100), t.moveTo(s, n), t.lineTo(s + 1, n), t.lineTo(s + 1, n + 1), t.lineTo(s, n + 1), t.endFill())
        }
      return t
    },
    ...
    mapData: function (o, e) {
      for (var r = -1, t = this.moduleCount - 1, i = 7, n = 0, a = this.moduleCount - 1; a > 0; a -= 2)
        for (6 == a && a--; ; ) {
          for (var s = 0; s < 2; s++)
            if (null == this.modules[t][a - s]) {
              var u = !1
              n < o.length && (u = 1 == ((o[n] >>> i) & 1)),
                l.getMask(e, t, a - s) && (u = !u),
                (this.modules[t][a - s] = u),
                -1 == --i && (n++, (i = 7))
            }
  ...
  (e.createData = function (o, r, t) {
    for (var i = p.getRSBlocks(o, r), n = new C(), a = 0; a < t.length; a++) {
      var s = t[a]
      n.put(s.mode, 4), n.put(s.getLength(), l.getLengthInBits(s.mode, o)), s.write(n)
    }
    var u = 0
  ...
  (e.createBytes = function (o, e) {
    for (var r = 0, t = 0, i = 0, n = new Array(e.length), a = new Array(e.length), s = 0; s < e.length; s++) {
      var u = e[s].dataCount,
        d = e[s].totalCount - u
      ;(t = Math.max(t, u)), (i = Math.max(i, d)), (n[s] = new Array(u))
      for (var g = 0; g < n[s].length; g++) n[s][g] = 255 & o.buffer[g + r]
      r += u
      var h = l.getErrorCorrectPolynomial(d),
        c = new f(n[s], h.getLength() - 1).mod(h)
      a[s] = new Array(h.getLength() - 1)
      for (g = 0; g < a[s].length; g++) {
        var m = g + c.getLength() - a[s].length
        a[s][g] = m >= 0 ? c.get(m) : 0
      }
    }
    var p = 0
    ...
    var C = new Array(p),
      b = 0
    for (g = 0; g < t; g++) for (s = 0; s < e.length; s++) g < n[s].length && (C[b++] = n[s][g])
    for (g = 0; g < i; g++) for (s = 0; s < e.length; s++) g < a[s].length && (C[b++] = a[s][g])
    return C
  })
for (
    ...
    l = {
      ...
      getLostPoint: function (o) {
        for (var e = o.getModuleCount(), r = 0, t = 0; t < e; t++)
          for (var i = 0; i < e; i++) {
            for (var n = 0, a = o.isDark(t, i), s = -1; s <= 1; s++)
              if (!(t + s < 0 || e <= t + s))
                for (var u = -1; u <= 1; u++) i + u < 0 || e <= i + u || (0 == s && 0 == u) || (a == o.isDark(t + s, i + u) && n++)
            n > 5 && (r += 3 + n - 5)
          }
        for (t = 0; t < e - 1; t++)
          for (i = 0; i < e - 1; i++) {
            var d = 0
            o.isDark(t, i) && d++, o.isDark(t + 1, i) && d++, o.isDark(t, i + 1) && d++, o.isDark(t + 1, i + 1) && d++, (0 != d && 4 != d) || (r += 3)
          }
        for (t = 0; t < e; t++)
          for (i = 0; i < e - 6; i++)
            o.isDark(t, i) &&
...
function y(o, e) {
  ...
  var a = (this.backgroundImageWidth = void 0),
    s = (this.backgroundImageHeight = void 0),
  ...
  var h = (this.foregroundImageWidth = void 0),
    l = (this.foregroundImageHeight = void 0),
  ...
  var p = (this.foregroundImageBorderRadius = 0),
    C = (this.foregroundImageShadowOffsetX = 0),
    k = (this.foregroundImageShadowOffsetY = 0),
    v = (this.foregroundImageShadowBlur = 0)
  ...
  var w = (this.foregroundPadding = 0),
    ...
    T = (this.positionAdjustForegroundColor = void 0),
  ...
  ;(this.drawReserve = !1),
    ...
    Object.defineProperties(this, {
      data: {
        get() {
          if ('' === r || void 0 === r) throw (console.error('[uQRCode]: data must be set!'), new y.Error('data must be set!'))
          return r
        },
        set(o) {
          r = String(o)
      ...
      backgroundImageHeight: {
        get() {
          return void 0 === s ? this.dynamicSize : this.useDynamicSize ? (this.dynamicSize / this.size) * s : s
        },
        set(o) {
          s = Number(o)
        },
      ...
      backgroundImageY: {
        get() {
          return void 0 === d ? 0 : this.useDynamicSize ? (this.dynamicSize / this.size) * d : d
        },
        set(o) {
          d = Number(o)
        },
        ...
        get() {
          if (void 0 === z)
            throw (
              ...
              new y.Error('use drawCanvas, you need to set the canvasContext!'))
            )
          return z
        },
        set(o) {
    ...
    y.plugins.forEach((o) => o(y, this, !1)),
    o && this.setOptions(o),
...
;(f.prototype = {
  ...
  (p.getRSBlocks = function (o, e) {
    var r = p.getRsBlockTable(o, e)
    if (null == r) throw new Error('bad rs block @ typeNumber:' + o + '/errorCorrectLevel:' + e)
    for (var t = r.length / 3, i = new Array(), n = 0; n < t; n++)
      for (var a = r[3 * n + 0], s = r[3 * n + 1], u = r[3 * n + 2], d = 0; d < a; d++) i.push(new p(s, u))
    return i
  }),
  (p.getRsBlockTable = function (o, e) {
    switch (e) {
      case t.L:
  ...
  (y.plugins = []),
  (y.use = function (o) {
    'function' == typeof o && y.plugins.push(o)
  }),
  (y.prototype.loadImage = function (o) {
    return Promise.resolve(o)
  }),
  (y.prototype.setOptions = function (o) {
    o &&
      ...
      (function (o = {}, e = {}, r = !1) {
        ...
        this,
        {
          ...
          backgroundColor: o.backgroundColor || o.background?.color,
          backgroundImageSrc: o.backgroundImageSrc || o.background?.image?.src,
          backgroundImageWidth: o.backgroundImageWidth || o.background?.image?.width,
          backgroundImageHeight: o.backgroundImageHeight || o.background?.image?.height,
          backgroundImageX: o.backgroundImageX || o.background?.image?.x,
          backgroundImageY: o.backgroundImageY || o.background?.image?.y,
          backgroundImageAlpha: o.backgroundImageAlpha || o.background?.image?.alpha,
          backgroundImageBorderRadius: o.backgroundImageBorderRadius || o.background?.image?.borderRadius,
          backgroundPadding: o.backgroundPadding,
          foregroundColor: o.foregroundColor || o.foreground?.color,
          foregroundImageSrc: o.foregroundImageSrc || o.foreground?.image?.src,
          foregroundImageWidth: o.foregroundImageWidth || o.foreground?.image?.width,
          foregroundImageHeight: o.foregroundImageHeight || o.foreground?.image?.height,
          foregroundImageX: o.foregroundImageX || o.foreground?.image?.x,
          foregroundImageY: o.foregroundImageY || o.foreground?.image?.y,
          foregroundImagePadding: o.foregroundImagePadding || o.foreground?.image?.padding,
          foregroundImageBackgroundColor: o.foregroundImageBackgroundColor || o.foreground?.image?.backgroundColor,
          foregroundImageBorderRadius: o.foregroundImageBorderRadius || o.foreground?.image?.borderRadius,
          foregroundImageShadowOffsetX: o.foregroundImageShadowOffsetX || o.foreground?.image?.shadowOffsetX,
          foregroundImageShadowOffsetY: o.foregroundImageShadowOffsetY || o.foreground?.image?.shadowOffsetY,
          foregroundImageShadowBlur: o.foregroundImageShadowBlur || o.foreground?.image?.shadowBlur,
          foregroundImageShadowColor: o.foregroundImageShadowColor || o.foreground?.image?.shadowColor,
          foregroundPadding: o.foregroundPadding,
          positionProbeBackgroundColor: o.positionProbeBackgroundColor || o.positionProbe?.backgroundColor || o.positionDetection?.backgroundColor,
          positionProbeForegroundColor: o.positionProbeForegroundColor || o.positionProbe?.foregroundColor || o.positionDetection?.foregroundColor,
          separatorColor: o.separatorColor || o.separator?.color,
          positionAdjustBackgroundColor: o.positionAdjustBackgroundColor || o.positionAdjust?.backgroundColor || o.alignment?.backgroundColor,
          positionAdjustForegroundColor: o.positionAdjustForegroundColor || o.positionAdjust?.foregroundColor || o.alignment?.foregroundColor,
          timingBackgroundColor: o.timingBackgroundColor || o.timing?.backgroundColor,
          timingForegroundColor: o.timingForegroundColor || o.timing?.foregroundColor,
          typeNumberBackgroundColor: o.typeNumberBackgroundColor || o.typeNumber?.backgroundColor || o.versionInformation?.backgroundColor,
          typeNumberForegroundColor: o.typeNumberForegroundColor || o.typeNumber?.foregroundColor || o.versionInformation?.foregroundColor,
          darkBlockColor: o.darkBlockColor || o.darkBlock?.color,
        },
        !0,
      ))
  }),
  (y.prototype.make = function () {
    let { foregroundColor: o, backgroundColor: r, typeNumber: t, errorCorrectLevel: i, data: n, size: a, margin: s, useDynamicSize: u } = this
    if (o === r)
      throw (
        (console.error('[uQRCode]: foregroundColor and backgroundColor cannot be the same!'),
        new y.Error('foregroundColor and backgroundColor cannot be the same!'))
      )
    var d = new e(t, i)
    d.addData(
      (function (o) {
      ...
      d.make(),
      (this.base = d),
      (this.typeNumber = d.typeNumber),
      (this.modules = d.modules),
      (this.moduleCount = d.moduleCount),
      (this.dynamicSize = u ? Math.ceil((a - 2 * s) / d.moduleCount) * d.moduleCount + 2 * s : a),
      (function (o) {
        let {
            dynamicSize: e,
            margin: r,
      ...
      (function (o) {
        let {
          ...
          positionAdjustBackgroundColor: s,
      ...
      (function (o) {
        ...
        for (let o = 0; o < n; o++) {
          var a = e[6][8 + o],
            s = e[8 + o][6]
          a.type.push('timing'), s.type.push('timing'), (a.color = (1 & o) ^ 1 ? t : i), (s.color = (1 & o) ^ 1 ? t : i)
        }
      })(this),
      (function (o) {
      ...
      (function (o) {
        ...
        ;[
          ...
          var t = r[o[0]][o[1]]
          t.type.push('typeNumber'), (t.color = '1' == s[e] ? n : i)
        })
      })(this),
      (this.isMaked = !0)
  }),
  ...
  (y.prototype.drawCanvas = function () {
    ...
    if (!o)
      return console.error('[uQRCode]: please execute the make method first!'), Promise.reject(new y.Error('please execute the make method first!'))
    let g = this.getDrawModules(),
      h = async (o, r) => {
        try {
          ...
          for (var i = 0; i < g.length; i++) {
            ...
            switch ((e.save(), n.type)) {
              ...
              case 'tile':
                ...
                e.beginPath(),
                  e.moveTo(a, s),
                  e.arcTo(a + d, s, a + d, s + h, 0),
                  e.arcTo(a + d, s + h, a, s + h, 0),
                  e.arcTo(a, s + h, a, s, 0),
                  e.arcTo(a, s, a + d, s, 0),
                  e.closePath(),
                  (e.fillStyle = n.color),
              ...
              case 'image':
                if ('backgroundImage' === n.name) {
                  ;(a = n.x), (s = n.y), (d = n.width), (h = n.height)
                  d < 2 * (c = n.borderRadius) && (c = d / 2),
                    h < 2 * c && (c = h / 2),
                    (e.globalAlpha = n.alpha),
                    e.beginPath(),
                    e.moveTo(a + c, s),
                    e.arcTo(a + d, s, a + d, s + h, c),
                    e.arcTo(a + d, s + h, a, s + h, c),
                    e.arcTo(a, s + h, a, s, c),
                    e.arcTo(a, s, a + d, s, c),
                    e.closePath(),
                    ...
                    e.clip()
                  try {
                    var l = await this.loadImage(n.imageSrc)
                    e.drawImage(l, n.x, n.y, n.width, n.height)
                  } catch (o) {
                    throw (console.error(`[uQRCode]: ${n.mappingName} invalid!`), new y.Error(`${n.mappingName} invalid!`))
                  }
                } else if ('foregroundImage' === n.name) {
                  var c
                  ;(a = n.x), (s = n.y), (d = n.width), (h = n.height)
                  d < 2 * (c = n.borderRadius) && (c = d / 2), h < 2 * c && (c = h / 2)
                  var m = n.x - n.padding,
                    f = n.y - n.padding,
                    p = n.width + 2 * n.padding,
                    C = n.height + 2 * n.padding,
                    b = (p / d) * c
                  p < 2 * b && (b = p / 2),
                    C < 2 * b && (b = C / 2),
                    e.save(),
                    ...
                    e.beginPath(),
                    e.moveTo(m + b, f),
                    e.arcTo(m + p, f, m + p, f + C, b),
                    e.arcTo(m + p, f + C, m, f + C, b),
                    e.arcTo(m, f + C, m, f, b),
                    e.arcTo(m, f, m + p, f, b),
                    e.closePath(),
                    ...
                    e.arcTo(m, f, m + p, f, b),
                    e.closePath(),
                    e.setFillStyle(n.padding > 0 ? n.backgroundColor : 'rgba(0,0,0,0)'),
                    e.fill(),
                    e.beginPath(),
                    e.moveTo(a + c, s),
                    e.arcTo(a + d, s, a + d, s + h, c),
                    ...
                    e.clip()
                  try {
                    l = await this.loadImage(n.imageSrc)
                    e.drawImage(l, n.x, n.y, n.width, n.height)
                  } catch (o) {
                    throw (console.error(`[uQRCode]: ${n.mappingName} invalid!`), new y.Error(`${n.mappingName} invalid!`))
                  }
          ...
          if (!(o instanceof y.Error)) throw o
          r(o)
        }
      }
  ...
  (y.prototype.register = function (o) {
    o && o(y, this, !0)
  })
export { y as default }
