<template>
    <div class="description">
        <div class="description__content">
            库存明细是以SKU为维度统计本供应商所有（代销、采购）商品库存变动的流水，记录了商品的发布、编辑、销售、退货、库存盘点、调拨 、采购等<br />
            操作，助力商家高效库存管理和结算。
        </div>
        ...
        <el-table :data="inboundTableData" border :header-cell-style="{ background: '#F5F7FA', color: '#000', height: '36px' }">
        ...
        <el-table :data="outboundTableData" border :header-cell-style="{ background: '#F5F7FA', color: '#000', height: '36px' }">
            <template #empty> <ElTableEmpty /> </template>
            <el-table-column prop="type" label="出入库类型" width="120" />
            <el-table-column prop="source" label="商品来源" width="120" />
            <el-table-column prop="recordMechanism" label="记录时机" width="230" />
