...
import { doGetInventoryCommodity } from '@/apis/good'
...
async function initComList() {
    ...
    const { code, data } = await doGetInventoryCommodity({
        ...
        supplierGoodsName: commodityInfo.supplierGoodsName,
        supplierProductId: commodityInfo.supplierProductId,
...
function resetComInfo() {
    ...
    commodityInfo.supplierProductId = ''
    commodityInfo.supplierGoodsName = ''
    commodityInfo.loading = false
...
<template>
    <div style="padding-top: 16px">
        <el-form ref="formRef" :model="storageForm" label-width="100px">
            <el-form-item label="类型">
                <el-radio-group v-model="storageForm.stockChangeType">
                    <el-radio label="ALLOCATION_INBOUND">调拨入库</el-radio>
                    <el-radio label="OTHER_INBOUND">其它入库</el-radio>
                    <el-radio label="ALLOCATION_OUTBOUND">调拨出库</el-radio>
                    <el-radio label="OTHER_OUTBOUND">其它出库</el-radio>
                </el-radio-group>
            </el-form-item>
            <el-form-item label="相关凭证">
                ...
                <el-row style="width: 100%">
                    ...
                    <q-upload
                        v-show="storageForm.evidence.length <= 3"
                        :width="100"
                        :height="100"
                        :format="{ size: 1 }"
            ...
            <el-form-item label="备注">
                <el-input v-model="storageForm.remark" :rows="3" type="textarea" placeholder="请输入备注" />
            </el-form-item>
        </el-form>
    </div>
            ...
            <el-row>
                <el-col :span="7">
                    <el-form-item label="商品名称">
                        <el-input v-model="commodityInfo.supplierGoodsName" placeholder="请输入商品名称" maxlength="20"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="7">
                    <el-form-item label="商品ID">
                        <el-input v-model="commodityInfo.supplierProductId" placeholder="请输入商品名称" maxlength="20"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="7">
