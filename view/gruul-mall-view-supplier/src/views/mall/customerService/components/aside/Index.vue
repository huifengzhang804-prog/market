<template>
    <div class="h100p">
        <AsideHeader @keyword-change="(val) => emits('keywordChange', val)" @search-focus="(val) => emits('searchFocus', val)" />
        <AsideMain :currentSelectUser="currentSelectUser" :messageUsers="messageUsers" @change="(val) => emits('change', val)" />
    </div>
</template>
