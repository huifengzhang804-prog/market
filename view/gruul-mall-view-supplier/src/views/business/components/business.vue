...
import { doGetUserDataAccount, doGetMyResetPasswordSms, doPutMyResetPassword, doGetCaptchaSlider } from '@/apis/sign'
...
const formFocusFields = reactive({
    code: false,
    password: false,
})
...
const handleToggleBindingPassword = () => {
    ...
    formFocusFields.code = false
    formFocusFields.password = false
    toggleBindingDialog.value = true
}
...
<template>
    <!-- <el-row :gutter="20">
        ...
        <el-col :span="5">
            ...
            <el-button type="primary" plain round @click="handleToggleBinding('vx')">换绑</el-button>
        </el-col>
    </el-row> -->
    ...
    <!-- <el-row :gutter="20">
        ...
        <el-col :span="5">
            <div class="grid-contents ep-bg-purple" />
            <el-button type="primary" plain round @click="handleToggleBinding('mobile')">换绑</el-button>
        </el-col>
    </el-row> -->
    <el-row :gutter="20">
        <el-col :span="4">
        ...
        <el-form v-if="isUpdatePassword" ref="ruleFormRef" :model="passwordForm" :rules="rules" label-width="100px">
            ...
            <el-form-item label="新密码" prop="password">
                <el-input
                    ...
                    :show-password="formFocusFields.password"
                    :type="formFocusFields.password ? 'password' : 'text'"
                    placeholder="6到20个字符"
                    style="width: 300px"
                    maxlength="20"
                    @keyup="handleStrengthShow"
                    @focus="formFocusFields.password = true"
                />
            </el-form-item>
                ...
                <el-row :gutter="24">
                    <el-col :span="14">
                        <el-input
                            ...
                            placeholder="4位数字验证码"
                            maxlength="4"
                            :type="formFocusFields.code ? 'text' : 'search'"
                            @focus="formFocusFields.code = true"
                            @blur="formFocusFields.code = false"
                        />
                    </el-col>
                    <el-col :span="6">
